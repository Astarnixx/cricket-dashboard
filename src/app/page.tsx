    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20">
      <div className="container mx-auto px-6 py-12">
        ...
        <motion.div
          ...
          className="glass-card modern-border-radius-card p-8 mb-16"
        >
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gradient mb-4">Platform Statistics</h2>
            <p className="text-gray-600 dark:text-gray-400">Comprehensive cricket data at your fingertips</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            >
              <div className="w-16 h-16 mx-auto mb-3 gradient-primary rounded-2xl flex items-center justify-center shadow-lg">
                <FiUsers className="w-8 h-8 text-white" />
              </div>
              <div className="text-3xl font-bold text-gradient mb-1">10+</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Top Players</div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="text-center"
            >
              <div className="w-16 h-16 mx-auto mb-3 gradient-secondary rounded-2xl flex items-center justify-center shadow-lg">
                <FiGlobe className="w-8 h-8 text-white" />
              </div>
              <div className="text-3xl font-bold text-gradient-warm mb-1">8+</div>
            ...
            <motion.div 
              ...
              className="text-center"
            >
              <div className="w-16 h-16 mx-auto mb-3 gradient-success rounded-2xl flex items-center justify-center shadow-lg">
            ...
            <motion.div 
              ...
              className="text-center"
            >
              <div className="w-16 h-16 mx-auto mb-3 gradient-warm rounded-2xl flex items-center justify-center shadow-lg">
        ...
        <motion.div
          ...
          className="text-center"
        >
          <div className="glass-card-hover modern-border-radius-card p-8 max-w-2xl mx-auto">
            <h2 className="text-3xl font-bold text-gradient mb-4">Ready to Explore?</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
              Start analyzing cricket players and discover insights that matter
            </p>
